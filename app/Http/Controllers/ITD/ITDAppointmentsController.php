...
class ITDAppointmentsController extends Controller
{
    public function index()
    {
        $appointments = Appointments::with('products', 'user')->get();
        return view('itd-leader.appointments.index', compact('appointments'));
    }
    ...
    public function create()
    {
        ...
        return view('itd-leader.appointments.create', compact('products', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('itd-leader.appointments.index')->with('success', 'Məlumatlar daxil edildi');
    }
    ...
    {
        $users = User::where('type', 'employee')->get();
        return view('itd-leader.appointments.edit', compact( 'users', 'appointment'));
    }
    ...
    public function update(Request $request, Appointments $appointment)
    {
        ...
        return redirect()->route('itd-leader.appointments.index')->with('success', 'Məlumatlar dəyişdirildi');
    }
