...
class ACCAppointmentsController extends Controller
{
    public function index()
    {
        $appointments = Appointments::with('products', 'user')->get();
        return view('accountant.appointments.index', compact('appointments'));
    }
    ...
    public function create()
    {
        ...
        return view('accountant.appointments.create', compact('products', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accountant.appointments.index')->with('success', 'Məlumatlar daxil edildi');
    }
    ...
    {
        $users = User::where('type', 'employee')->get();
        return view('accountant.appointments.edit', compact( 'users', 'appointment'));
    }
    ...
    public function update(Request $request, Appointments $appointment)
    {
        ...
        return redirect()->route('accountant.appointments.index')->with('success', 'Məlumatlar dəyişdirildi');
    }
