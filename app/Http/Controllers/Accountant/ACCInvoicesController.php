...
class ACCInvoicesController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('accountant.invoices.create', compact('categories', 'vendors', 'registers', 'whs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accountant.invoices.index')->with('success', 'Məlumatlar daxil edildi');
    }
