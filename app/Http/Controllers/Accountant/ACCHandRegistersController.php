...
class ACCHandRegistersController extends Controller
{
    public function index()
    {
        $registers = HandRegisters::all();
        return view('accountant.hand-registers.index', compact('registers'));
    }
    ...
    public function create()
    {
        ...
        return view('accountant.hand-registers.create', compact('categories', 'vendors', 'whs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accountant.hand-registers.index')->with('success', 'Məlumatlar daxil edildi');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('accountant.hand-registers.show', compact('register'));
    }
