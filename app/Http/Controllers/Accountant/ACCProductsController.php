...
class ACCProductsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('accountant.products.index', compact('products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accountant.products.index')->with('success', 'Məlumatlar əlavə edildi');
    }
    ...
    public function details(Request $request)
    {
        ...
        return view('accountant.warehouses.products.details', compact('products', 'users'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('accountant.products.edit', compact('product', 'categories'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('accountant.invoices.show',$product->invoices_id)->with('success', 'Məlumatlar dəyişdirildi');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json([
            ...
            'route' => route('accountant.invoices.show', $invoice_id)
        ]);
    }
