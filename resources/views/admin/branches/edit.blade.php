                    ...
                    <form method="POST" action="{{route('admin.branches.update', $branch->id)}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <select id="status" name="departments_id"
                                        class="form-control ui fluid search dropdown create_form_dropdown">
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ $department->id == $branch->departments_id ? 'selected' : '' }}>{{ $department->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <div class="select_label ui sub header ">Şöbə adı</div>
