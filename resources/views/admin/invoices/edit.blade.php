            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3>{{ $invoice->e_invoice_number .' '. $invoice->e_invoice_serial_number }}</h3>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <select frequency="true" required id="register_or_new"
                                                    name="register_or_new"
                                        ...
                                        <div class="col-md-3 form-group mb-3 " id="vendors-section">
                                            ...
                                            <select frequency="true" required id="vendors_select" name="vendors_id"
                                                    class="form-control ui fluid search dropdown create_form_dropdown vendors_select_cl">
                                                <option value="">Təminatçı seçin</option>
                                                @forelse($vendors as $item)
                                                    <option
                                                        value="{{$item->id}}" {{ $invoice->vendors_id==$item->id ? 'selected' : '' }}>{{$item->name}}</option>
                                                @empty
                                        ...
                                        <div class="col-md-3 form-group mb-3 " id="categories-section">
                                            ...
                                            <select frequency="true" required id="categories_id"
                                                    name="main_categories_id"
                                                    class="form-control ui fluid search dropdown create_form_dropdown vendors_select_cl">
                                                <option value="">Əsas kategoriya seçin</option>
                                                @forelse($categories as $category)
                                                    <option
                                                        value="{{$category->id}}" {{ $invoice->categories_id==$category->id ? 'selected' : '' }}>{{$category->name}}</option>
                                                @empty
                                                    <option disabled selected>Məlumat yoxdur</option>
                                                @endforelse
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            <div class="select_label ui sub header ">E-qaimə nömrəsi / Seria nömrəsi
                                            </div>
                                            <div class="ui input">
                                                <input id="e_invoice_number" required
                                                       value="{{ $invoice->e_invoice_number }}"
                                                       name="e_invoice_number" type="text"
                                                       placeholder="E-Qaimə nömrəsi">
                                                <input id="e_invoice_serial_number" required
                                                       value="{{ $invoice->e_invoice_number }}"
                                                       name="e_invoice_serial_number" type="text"
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <select frequency="true" required id="warehouses_id" name="warehouses_id"
                                                    class="form-control ui fluid search dropdown create_form_dropdown warehouses_select_cl">
                                                <option value="">Anbar seçin</option>
                                                @foreach($whs as $wh)
                                                    <option
                                                        value="{{ $wh->id }}" {{ $invoice->products()->first()->warehouses->id==$wh->id ? 'selected' : '' }}>{{ $wh->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <div class="ui input">
                                                <input id="e_invoice_date" required
                            ...
                            @if($invoice->hand_registers->count() > 0)
                                <div class="row position-relative form_block" id="hand_registers_section">
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <select frequency="true" id="hand_registers_id" required multiple
                                                name="hand_registers_id[]"
                                                class="form-control ui fluid search dropdown create_form_dropdown vendors_select_cl">
                                            <option value="">Əl qaimələri seçin</option>
                                            @foreach($registers as $register)
                                                <option value="{{ $register->id }}">{{ $register->register_number }}
                                                    - {{ $register->total_amount }} AZN ({{ $register->register_date }})
                                                </option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger error_message" id="subcategories_idError"></span>
                            ...
                            @else
                                <div class="row position-relative form_block" id="formRow">
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <select frequency="true" id="subcategories_id" required
                                    ...
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <select frequency="true" id="material_type" required name="material_type[]"
                                                class="form-control ui fluid search dropdown create_form_dropdown material_type_select_cl">
                                    ...
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <div class="ui input">
                                            <input id="product_name" required value="{{old('product_name')}}"
                                                   ...
                                                   placeholder="İnventar adını daxil edin">
                                        </div>
                                    ...
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <div class="ui input">
                                            <input id="inventory_cost" required value="{{old('inventory_cost')}}"
                                                   name="inventory_cost[]" type="number" step=any
                                                   placeholder="İnventar dəyəri">
                                        </div>
                                        ...
                                        <div class="input_container">
                                            ...
                                            <div class="ui input">
                                                <input id="purchase_count" required value="{{old('purchase_count')}}"
                                                       ...
                                                       placeholder="Alış sayını daxil edin">
                                            </div>
                                            <span class="text-danger error_message" id="purchase_countError"></span>
                                        </div>

                                        <button type="button" id="main_inventory_number_btn"
                                                class="btn btn-primary d-none main_inventory_btn_cls"
                                                data-bs-toggle="modal" data-bs-target="">
                                            AVR kodu / Seria nömrəsi
                                        </button>
                                    </div>

                                    <div class="col-md-3 form-group mb-3">
                                        <div class="select_label ui sub header ">Aktivlik statusu</div>
                                        <select frequency="true" id="activity_status" required name="activity_status[]"
                                                class="form-control ui fluid search dropdown create_form_dropdown vendors_select_cl">
                                    ...
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <select frequency="true" id="status" required name="status[]"
                                                class="form-control ui fluid search dropdown create_form_dropdown vendors_select_cl">
...
@section('js')
    ...
    <script>
        ...
        $('#categories_id').on("change", function (e) {
            ...
            $.ajax({
                url: "{{ url('admin/get-subcategories-by-main-category') }}",
                type: "POST",
                data: {
                    "_token": "{{csrf_token()}}",
